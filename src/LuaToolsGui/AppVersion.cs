...
{
    /// <summary>e.g. <c>"1.5.4"</c>. The <c>+commit</c> suffix the SDK appends is trimmed.</summary>
    public static string Current { get; } = Read();

    /// <summary>What outbound HTTP identifies this app as, e.g. <c>"LuaToolsAmethyst/1.5.4"</c>.
